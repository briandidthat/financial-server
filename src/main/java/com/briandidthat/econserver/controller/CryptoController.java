...
public class CryptoController {
    ...
    public Statistic getCryptoPriceStatistics(@RequestHeader String caller, @RequestParam String symbol, @RequestParam LocalDate startDate, @RequestParam LocalDate endDate) {
